...
function next () {
  HYPE.documents['HYPE_CCG'].continueTimelineNamed('Main Timeline', HYPE.documents['HYPE_CCG'].kDirectionForward, false);
}

// Call for a stop from CasparCG client
function stop () {
  HYPE.documents['HYPE_CCG'].showSceneNamed('Stop', HYPE.documents['HYPE_CCG'].kSceneTransitionCrossfade, 0.25);
